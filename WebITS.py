...
class get_result(object):
    def __init__(self,host,text,lang_from,lang_to,xunfei_appid,xunfei_secret,xunfei_key):
        # 应用ID（到控制台获取）
        self.APPID = xunfei_appid
        # 接口APISercet（到控制台机器翻译服务页面获取）
        self.Secret = xunfei_secret
        # 接口APIKey（到控制台机器翻译服务页面获取）
        self.APIKey= xunfei_key
...
if __name__ == '__main__':
    ...
    #初始化类
    gClass=get_result(host,"hello","en","cn")
    gClass.call_url()
